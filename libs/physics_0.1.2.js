...
var zim = function(zim) {
	...
	zim.Physics = function(frame, borders, gravity) {
		...
		this.Drag = function(list) {
			...
			var mousemoveEvent;
			var mousedownEvent = stage.on("stagemousedown", function() {
				isMouseDown = true;
				mouseX = stage.mouseX/scale;
				mouseY = stage.mouseY/scale;
				mousemoveEvent = stage.on("stagemousemove", function() {
					mouseX = stage.mouseX/scale;
					mouseY = stage.mouseY/scale;
				});
			});
			var mouseupEvent = stage.on("stagemouseup", function() {
				isMouseDown = false;
